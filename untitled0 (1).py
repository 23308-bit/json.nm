...
Original file is located at
    https://colab.research.google.com/drive/1Gf02EYLhZdHkCqY_JfEzUM1GAFT3CqR2
"""
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    json_for_case = gr.Code(
                        ...
                        label="Input JSON",
                        lines=10,
                        value='{"firstName": "Vaishali", "lastName": "David"}'
                    )
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    json3 = gr.Code(
                        ...
                        lines=8,
                        value='{"email": "Vaishali@gmail.com"}'
                    )
                ...
                with gr.TabItem("Flatten"):
                    ...
                    with gr.Row():
                        flatten_input = gr.Code(
                            ...
                            label="Nested JSON",
                            lines=10,
                            value='{"user": {"name": "Vaishali", "age": 20}}'
                        )
                ...
                with gr.TabItem("Unflatten"):
                    ...
                    with gr.Row():
                        unflatten_input = gr.Code(
                            ...
                            label="Flattened JSON",
                            lines=10,
                            value='{"user.name": "Vaishali", "user.age": 20}'
                        )
